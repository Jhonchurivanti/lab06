              ...
              <div class="col-md-6 mt-5" >
                  <div class="card">
                      <div class="card-header --bs-body-color">
                         <div class="card-tittle text-black text-center"><strong>Registro de Matrícula</strong></div> 
                      </div>                               
                      <div class="card-body">
                          <form name="formAlumno" action="ingresar_matricula.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="cursos_id" class="form-control">
                                    ...
                                    $resultado=mysqli_query($conexion, $sql);
                                    while($filas=mysqli_fetch_array($resultado)) {
                                       echo "<option value='".$filas['id']."'>".$filas['nombre']." ".$filas['ape_paterno']." ".$filas['ape_materno']."</option>";
                                    }
                                    ?>
